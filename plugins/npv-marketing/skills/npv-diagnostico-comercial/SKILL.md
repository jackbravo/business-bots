...
Usar lenguaje cotidiano y directo. Explicar qué se necesita y para qué sin recitar la metodología interna.
...
Ajustar la profundidad al material disponible. Una respuesta útil debe dejar claro:
- qué se quiere mejorar;
- qué sugieren los datos disponibles;
- cuáles son las posibles causas relevantes;
- qué falta comprobar;
